          ...
          <div className="bg-white rounded-2xl p-4 border border-slate-200 shadow-sm space-y-3">
            <div className="flex items-center justify-between border-b border-slate-100 pb-2">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-xs font-bold text-slate-800">{lang === 'fr' ? 'Synchronisation GitHub Gist' : 'مزامنة GitHub Gist'}</h3>
              </div>
            ...
            <p className="text-[11px] text-slate-500 font-medium">
              {lang === 'fr' ? 'Sauvegarde et restauration sécurisée dans le cloud.' : 'حفظ واستعادة بيانات التطبيق والوثائق على السحابة بآمان.'}
            </p>
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              >
                <UploadCloud className="w-4 h-4" />
                <span>{lang === 'fr' ? 'Sauvegarder Gist' : 'رفع إلى Gist'}</span>
              </button>
              ...
              >
                ...
                <span>{lang === 'fr' ? 'Restaurer Gist' : 'استعادة من Gist'}</span>
              </button>
            </div>
          </div>
        </div>
